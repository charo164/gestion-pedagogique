...
@Component({
  selector: 'app-attache-session-course',
  templateUrl: './attache-session-course.component.html',
  styleUrls: ['./attache-session-course.component.css'],
})
export class AttacheSessionCourseComponent implements OnInit {
  ...
  handleEvent(action: string, event: CalendarEvent): void {
    this.router.navigate(['/attache/session-course/details', event.id]);
  }
